...
function Leaderboard() {
    ...
    return (
        ...
        <div className="flex h-screen w-screen overflow-hidden bg-slate-50" style={{
            ...
            <div className="flex-1 ml-80 h-screen flex items-center justify-center">
                <div className="w-full max-w-4xl flex flex-col ml-20 mr-20" style={{ maxHeight: '90vh' }}>
                    {/* Container with transparent black background */}
                    <div
                    ...
                    >
                        ...
                        <div className="mb-8 text-center">
                            ...
                            <p className="text-white text-lg">Top explorers around the world</p>
                        </div>
                                ...
                                <div className={`w-full bg-white rounded-2xl shadow-2xl ${leaderboard.length > 10 ? 'h-full flex flex-col' : ''}`}>
                                    ...
                                    <div className={`${leaderboard.length > 10 ? 'flex-1 overflow-y-auto' : ''}`}>
                                        {leaderboard.map((user, index) => (
                                            <div
                                                key={user.userId}
                                                className={`grid grid-cols-12 gap-4 px-8 py-5 border-b border-gray-200 hover:bg-slate-50 transition-colors duration-200 ${index === 0 ? 'bg-yellow-50' : index === 1 ? 'bg-gray-100' : index === 2 ? 'bg-orange-50' : ''
                                                    }`}
                                            >
                                                {/* Rank Column */}
